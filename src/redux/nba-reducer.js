...
function matchesFormula() {
    // let homeMatches = matches.filter(item => (item.homeTeamMoreProcent>49 && item.homeTeamMoreProcent<51));
    let matchesWithProcent = matches.filter(item => item.homeTeamMoreProcent>=0);
    let homeMatchesMore = matchesWithProcent.filter(item => item.homeTotalMore);
    let procentHomeMore = Math.round((homeMatchesMore.length/matchesWithProcent.length)*100);
    // console.log(matchesWithProcent,"matchesWithProcent")
    // console.log(homeMatchesMore,"homeMatchesMore")
    // console.log(procentHomeMore,"procentHomeMore")

    let guestMatches = matches.filter(item => (item.guestTeamMoreProcent>60 && item.guestTeamMoreProcent<70));
    ...
    let middleProcentGuestMatches= matches.filter(item => 
       (item.middleProcentGuestMore>40 && item.middleProcentGuestMore<60));
...
let initialState = {
    teams: [
        ...
        {id: 24, name: 'Charlotte', logo: 'https://th.bing.com/th/id/OIF.5IWO1AjDYZjVBqQvwj0WqA?w=187&h=180&c=7&r=0&o=5&pid=1.7', homeMore: homeMore(24), guestMore: guestMore(24), homeEnemy: homeEnemy(24), guestEnemy: guestEnemy(24), middleHomePoints: middleHomePoints(24), middleGuestPoints: middleGuestPoints(24), middleHomeEnemyPoints: middleHomeEnemyPoints(24), middleGuestEnemyPoints: middleGuestEnemyPoints(24)},
        ...
        {id: 27, name: 'Philadelphia', logo: 'https://th.bing.com/th/id/OIF.fZJQTTMakyRiY4rWvcX7Jw?w=192&h=192&c=7&r=0&o=5&pid=1.7', homeMore: homeMore(27), guestMore: guestMore(27), homeEnemy: homeEnemy(27), guestEnemy: guestEnemy(27), middleHomePoints: middleHomePoints(27), middleGuestPoints: middleGuestPoints(27), middleHomeEnemyPoints: middleHomeEnemyPoints(27), middleGuestEnemyPoints: middleGuestEnemyPoints(27)},
        ...
        {id: 30, name: 'Washington', logo: 'https://th.bing.com/th?id=OIF.91G3E%2fXauyYr9mCCaSuhig&w=192&h=192&c=7&r=0&o=5&pid=1.7', homeMore: homeMore(30), guestMore: guestMore(30), homeEnemy: homeEnemy(30), guestEnemy: guestEnemy(30), middleHomePoints: middleHomePoints(30), middleGuestPoints: middleGuestPoints(30), middleHomeEnemyPoints: middleHomeEnemyPoints(30), middleGuestEnemyPoints: middleGuestEnemyPoints(30)},
      ],
      statistic: statistic,
}
...
const nbaReducer = (state = initialState) => {  
    return state;
}
